...
|[^]))*'`, t = `--[\\w-]+=(?:<STR>|(?!["'])(?:[^\\s\\\\]|\\\\.)+)`.replace(/<STR>/g, function() {
      ...
      !function() {
        if ("undefined" != typeof Prism && "undefined" != typeof document) {
          var e = /(?:^|\s)command-line(?:\s|$)/, t = "command-line-prompt", n = "".startsWith ? function(e2, t2) {
            return e2.startsWith(t2);
          } : function(e2, t2) {
            return 0 === e2.indexOf(t2);
          }, a = "".endsWith ? function(e2, t2) {
            return e2.endsWith(t2);
          } : function(e2, t2) {
            var n2 = e2.length;
            return e2.substring(n2 - t2.length, n2) === t2;
          };
          Prism.hooks.add("before-highlight", function(i) {
            ...
            if (!o.complete && i.code) {
              ...
              if (s && /pre/i.test(s.nodeName) && (e.test(s.className) || e.test(i.element.className))) {
                ...
                var u = o.outputLines = [], c = s.getAttribute("data-output"), d = s.getAttribute("data-filter-output");
                if (null !== c)
                  c.split(",").forEach(function(e2) {
                    var t2 = e2.split("-"), n2 = parseInt(t2[0], 10), a2 = 2 === t2.length ? parseInt(t2[1], 10) : n2;
                    if (!isNaN(n2) && !isNaN(a2)) {
                      n2 < 1 && (n2 = 1), a2 > m.length && (a2 = m.length), a2--;
                ...
                for (var f = o.continuationLineIndicies = /* @__PURE__ */ new Set(), h = s.getAttribute("data-continuation-str"), v = s.getAttribute("data-filter-continuation"), g = 0; g < m.length; g++) {
                  var b = m[g];
              ...
              o.complete = true;
          }), Prism.hooks.add("before-insert", function(e2) {
            var t2 = r(e2);
            if (!t2.complete) {
              for (var n2 = e2.highlightedCode.split("\n"), a2 = t2.outputLines || [], i = 0, o = n2.length; i < o; i++)
                a2.hasOwnProperty(i) ? n2[i] = '<span class="token output">' + Prism.util.encode(a2[i]) + "</span>" : n2[i] = '<span class="token command">' + n2[i] + "</span>";
              e2.highlightedCode = n2.join("\n");
            }
          }), Prism.hooks.add("complete", function(n2) {
            if (function(e2) {
              return "command-line" in (e2.vars = e2.vars || {});
            }(n2)) {
              var a2 = r(n2);
              if (!a2.complete) {
                var i = n2.element.parentElement;
                e.test(n2.element.className) && (n2.element.className = n2.element.className.replace(e, " ")), e.test(i.className) || (i.className += " command-line");
                var o, s = "", l = a2.numberOfLines || 0, m = b("data-prompt", "");
                o = "" !== m ? '<span data-prompt="' + m + '"></span>' : '<span data-user="' + b("data-user", "user") + '" data-host="' + b("data-host", "localhost") + '"></span>';
                for (var u = a2.continuationLineIndicies || /* @__PURE__ */ new Set(), c = '<span data-continuation-prompt="' + b("data-continuation-prompt", ">") + '"></span>', d = 0; d < l; d++)
                  u.has(d) ? s += c : s += o;
                var p = document.createElement("span");
                p.className = t, p.innerHTML = s;
                for (var f = a2.outputLines || [], h = 0, v = f.length; h < v; h++)
                  if (f.hasOwnProperty(h)) {
                    var g = p.children[h];
                    g.removeAttribute("data-user"), g.removeAttribute("data-host"), g.removeAttribute("data-prompt");
                  }
                n2.element.insertBefore(p, n2.element.firstChild), a2.complete = true;
              }
            }
            function b(e2, t2) {
              return (i.getAttribute(e2) || t2).replace(/"/g, "&quot");
            }
          });
        }
        function r(e2) {
          var t2 = e2.vars = e2.vars || {};
          return t2["command-line"] = t2["command-line"] || {};
        }
      }();
    }
  });
